...
public class DiskCache implements ICache {
    ...
    public DiskCache(Context context) {
        this(context, getDiskCacheDir(context, CommonConfig.CACHE_DISK_DIR),
                calculateDiskCacheSize(getDiskCacheDir(context, CommonConfig.CACHE_DISK_DIR)));
    }
    ...
    public void put(String key, Object value) {
        put(key, value != null ? HttpRequestManager.GSON.toJson(value) : null);
    }
            ...
            if (snapshot != null) {
                ...
                if (!TextUtils.isEmpty(content)) {
                    ...
                    if ((createTime + expireMills > Calendar.getInstance().getTimeInMillis())
                            || expireMills == CommonConfig.CACHE_NEVER_EXPIRE) {
